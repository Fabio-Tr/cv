<x-layout>
    ...
    <div class="container musthead d-flex align-items-center">
        ...
        <div class="container d-flex justify-content-center align-items-center home-container rounded" id="home">
            <div class="row justify-content-center d-flex align-items-center">
                ...
                <p class="col-8 pt-5">
                    ...
                    La mia formazione si è concretizzata tramite il Coding Bootcamp per Web Developers di Aulab che mi
                    ha
                    fornito basi e competenze tali da iniziare il mio viaggio in questo ambito lavorativo.
                    Ansioso di mettermi in gioco e continuare a migliorare ed aumentare le mie conoscenze, sono in grado
                    di
            ...
            <div class="row justify-content-center">
                ...
                <div class="row col-12 col-md-5">
                    ...
                    <p class="col-12">
                        ...
                        Console Linux, pagine statiche Html/Css, basi di Javascript, Bootstrap 4 (Grid system), GitLab,
                        Seo
        ...
        <div class="container justify-content-center align-items-center contact-form  rounded" style="display: none;"
            id="contact">
