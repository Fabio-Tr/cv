<x-layout>
    ...
    <div itemscope itemtype="https://www.knefas.eu/Person">
        ...
        <div class="container musthead d-flex align-items-center">
            ...
            <div class="container d-flex justify-content-center align-items-center home-container rounded pt-3" id="home">
                <div class="row justify-content-center d-flex align-items-center">
                    <div class="row col-12 d-flex justify-content-center align-items-center">

                        <div class="row col-12 col-md-6 text-end">
                            <h1 class="col-12" itemprop="name">Fabio Trani</h1>
                            <h3 class="col-12 fst-italic" itemprop="jobTitle">Full-Stack Web Developer</h3>
                        </div>
                        <h2 class="col-12 col-md-6 text-start">Curriculum Vitae</h2>
                    </div>
                    <p class="col-12 pt-5" itemscope itemtype="knowsAbout">
                        ...
                        Ansioso di mettermi in gioco e continuare a migliorare ed aumentare le mie conoscenze, sono
                        in
                        grado
                        di
            ...
            <div class="container justify-content-center cv-container rounded" style="display: none;" id="cv">
                <div class="row justify-content-center">
                    ...
                    <div class="row col-12 col-md-5">
                        ...
                        <p class="col-12">
                            ...
                            Console Linux, pagine statiche Html/Css, basi di Javascript, Bootstrap 4 (Grid system),
                            GitLab,
                            Seo
                    ...
                    <div class="row col-12 col-md-5">
                        ...
                        <p class="col-12">
                            ...
                            Gestione di una rete di punti vendita con passaggi settimanali prefissati con il compito di
                            gestire
                            gli allestimenti sia fuori banco che a lineare con attenzione alla freschezza del prodotto e
                            alla
                            corretta esposizione ed i rapporti col cliente - Rifacimenti display - Rilevazioni - Ordini
                            in
            ...
            <div class="container justify-content-center align-items-center contact-form  rounded"
                style="display: none;" id="contact">
                <div class="row justify-content-center align-items-center">
                    <h2 class="col-12 text-center">Contattami</h2>
